...
const Swap = () => {
  ...
  return (
    <>
          ...
          <CardBody>
            <AutoColumn gap="md">
              ...
              <CurrencyInputPanel
                ...
                label={
                  independentField === Field.INPUT && !showWrap && trade ? t('toestimated') : t('to')
                }
                showMaxButton={false}
            ...
            <BottomGrouping>
              {!account ? (
                ...
                <GreyCard style={{ textAlign: 'center' }}>
                  <Main mb="4px">{t('insufficientforthistrade')}</Main>
                </GreyCard>
              ) : showApproveFlow ? (
                <RowBetween>
                  <Button
                  ...
                  >
                    {priceImpactSeverity > 3 && !isExpertMode
                      ? `Price Impact High`
                      : `${t('titleswap')} ${priceImpactSeverity > 2 ? ' Anyway' : ''}`}
                  </Button>
                </RowBetween>
              ) : (
                <Button
      ...
      {/* <Flex>
        <img alt="" src={isDark ? "./images/egg/SM_white.png" : "./images/egg/SM_black.png" } width="36px"/>
        <Text fontSize="14px" ml="8px" mt="8px">{t('poweredby')}</Text>
      </Flex> */}
    </>
  )
}
